...
export type Dictionary = {
  ...
  compare: {
    ...
    duelMetaTitle: string;
    duelMetaDescription: string;
    duelIntro: string;
    duelOpenComparator: string;
    duelRelatedTitle: string;
    popularTitle: string;
    verdictTitle: string;
    verdictWinsOn: string;
  ...
  brandDuel: {
    ...
    rowLabel: string;
    rowKnownFor: string;
    rowCatalogSize: string;
    rowLaserTypes: string;
    rowPriceRange: string;
    rowAvgScore: string;
    rowHeadquarters: string;
    modelsCount: string;
    chooseTitle: string;
    chooseIf: string;
    reasonBudget: string;
    reasonBreadth: string;
    reasonAvgScore: string;
    ...
    popularTitle: string;
    faqTitle: string;
    faqWhichBrandQ: string;
    faqWhichBrandA: string;
    faqWhichBrandTieA: string;
    faqCheaperBrandQ: string;
    faqCheaperBrandA: string;
    faqDifferenceBrandQ: string;
    faqDifferenceBrandA: string;
    faqFlagshipQ: string;
    faqFlagshipA: string;
  };
  bestOf: {
